...
public class PlayerUI : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        GameManager.Instance.OnCurrentPlayableTypeChanged += GameManager_OnCurrentPlayablePlayerTypeChanged;
    ...
    {
        if(GameManager.Instance.GetCurrentcurrentPlayablePlayerType() == GameManager.PlayerType.Cross)
        {
